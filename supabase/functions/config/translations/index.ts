...
const bundled: Record<string, Translations> = {
  ...
  fa, fi, fr, ga, gl, gu, he, hi, hr, hu, hy, id, is, it, ja, ka, kk, km,
  kn, ko, ku, lt, lv, mk, ml, mn, mr, ms, mt, my, ne, nl, no, pa, pl, ps,
  pt, ro, ru, si, sk, sl, so, sq, sr, sv, sw, ta, te, th, tl, tr, uk, ur,
  uz, vi, zh,
};
