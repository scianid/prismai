...
/** Strip blocked query params (and OAuth-style fragments) from a URL string.
 *  Returns the input unchanged when there's nothing to strip or it doesn't
 *  parse as a URL. */
